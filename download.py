...
if __name__ == "__main__":
    ...
    local_dir = "HKU-DASC7606-A2/phi-1_5" # replace "xxx" with a real path and make sure that it has at least 3G of space

    download_from_hf_hub(repo_id=repo_id, use_auth_token=use_auth_token, local_dir=local_dir)


    repo_id = "BAAI/bge-small-en-v1.5"
    local_dir = "HKU-DASC7606-A2/bge-small-en-v1.5"
    download_from_hf_hub(repo_id=repo_id, use_auth_token=use_auth_token, local_dir=local_dir)
